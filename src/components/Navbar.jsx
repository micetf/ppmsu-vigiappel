                ...
                px-4 pb-3 md:p-0 shadow-lg md:shadow-none`}
                        >
                            ...
                            <ul className="flex items-center space-x-2 py-1 md:py-0">
                                {/* ✅ Bouton Aide — visible et libellé explicite */}
                                <li>
                                    <button
                                        type="button"
                                        onClick={() => {
                                        ...
                                        className="px-3 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition my-1 mx-1 flex items-center gap-1.5 text-sm font-medium"
